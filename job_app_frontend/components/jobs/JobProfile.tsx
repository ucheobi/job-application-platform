...
const JobProfile = ({ jobs, handleSetValue }: JobProfileProps) => { 
  ...
  const handleApplyJob = () => {
    if (profileData) {
      // if applicant has a profile, take user do job application tab for more info
